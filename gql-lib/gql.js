...
/** ===========================================================================
 * Original Source: https://github.com/timqian/gql-generator
 * ----------------------------------------------------------------------------
 * Copied again here to fix a bug generating union query types.
 * ============================================================================
 */
...
const generateQuery = (
  ...
  if (curType.getFields) {
    const crossReferenceKey = `${curParentName}To${curName}KeyFor${curParentType}`;
